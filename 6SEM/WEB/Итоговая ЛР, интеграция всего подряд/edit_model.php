...
<h2>Редактирование названия модели</h2>
<form method="post">
Название: <input type="text" name="edit_model_name" value="<?php echo $edit_model_name; ?>"><br>
Описание: <input type="text" name="edit_description" value="<?php echo $edit_description; ?>"><br>
