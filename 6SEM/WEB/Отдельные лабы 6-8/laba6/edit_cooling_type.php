...
<h2>Edit Cooling Type</h2>
<form method="post">
Type Name: <input type="text" name="edit_cooling_type_name" value="<?php echo $edit_cooling_type_name; ?>"><br>
Description: <input type="text" name="edit_cooling_type_description" value="<?php echo $edit_cooling_type_description; ?>"><br>
