...
# Что такое базовый случай? Базовый случай в рекурсии — это условие, при котором рекурсивная функция перестает вызывать саму себя. 
# Он предотвращает бесконечное выполнение рекурсии и является конечным состоянием вычислений.
# Какие фукнкции можно вычислить рекурсивно?
# Рекурсивно можно вычислить функции, которые можно разбить на более простые подзадачи с идентичной структурой.
# ------------------------------------------------------
