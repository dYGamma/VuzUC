...
# Разделение данных на обучающее и тестовое множества, а - задает базовый уровень трудозатрат для проекта данного типа. b - Определяет степень зависимости трудозатрат от размера проекта
...
# Параметры COCOMO для различных типов ПО позволяет COCOMO учитывать реальную сложность проекта и точнее оценивать ресурсы, необходимые для его выполнения
cocomo_params = {
    "1": ("организационное", (2.4, 1.05)),
    "2": ("базовое", (2.5, 1.2)),
    "3": ("усложнённое", (2.8, 1.35))
}

print("\n=== Выбор типа программного обеспечения ===")
print("1: Организационное")
print("2: Базовое")
print("3: Усложнённое")
software_choice = input("Выберите тип ПО (1/2/3): ") or "2"
software_type, (a, b) = cocomo_params.get(software_choice, cocomo_params["2"])
print(f"Выбран тип ПО: {software_type} (a = {a}, b = {b})")
