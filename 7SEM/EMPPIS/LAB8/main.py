...
# В результате выполнения лабораторной работы был разработан эволюционный 
# алгоритм на основе генетического алгоритма для оценки стоимости программных 
# проектов, реализованный на языке Python. Проведенное тестирование на основе 
# модели COCOMO показало приемлемую точность предсказаний, подтверждая 
# эффективность применения эволюционных методов для решения задач оценки 
# стоимости в программной инженерии. 
...
software_type = "базовое"  # Измените на "организационное" или "усложнённое" по желанию
