...
% Scope для визуализации результатов
add_block('simulink/Sinks/Scope', [modelName '/Scope'], ...
    'Position', [x_out_pos, y_pos + 50, x_out_pos + blockWidth, y_pos + 50 + blockHeight]);
...
% Интеграторы -> Scope
add_line(modelName, 'Integrator_x/1', 'Scope/1'); % x(t)
add_line(modelName, 'Integrator_y/1', 'Scope/2'); % y(t)
