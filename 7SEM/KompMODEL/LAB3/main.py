...
print("\n══════════════════════════════════════════════════")
print("    Скорректированные R^2 для f2 (полиномы разных степеней):")
print("══════════════════════════════════════════════════")
...
print("\n══════════════════════════════════════════════════")
print("           Прогнозы для 8-го интервала:")
print("══════════════════════════════════════════════════")
...
print("\n══════════════════════════════════════════════════")
print("       Сравнение моделей по метрикам точности:")
print("                (MSE, MAE)")
print("══════════════════════════════════════════════════")

# Полином 2-й степени
print("\n  • Полином 2-й степени (f1):")
print(f"    ─ MSE: {mse_f1:.2f}")
print(f"    ─ MAE: {mae_f1:.2f}")

# Лучший полином
print(f"\n  • Лучший полином степени {degrees[best_degree_index]} (f2):")
print(f"    ─ MSE: {mse_f2:.2f}")
print(f"    ─ MAE: {mae_f2:.2f}")

# Модель с кубическим корнем
print(f"\n  • Модель с кубическим корнем (f3):")
